...
{
    [CustomPropertyDrawer(typeof(CompositeStatusCondition))]
    public class StatusConditionsDrawer : PropertyDrawer
    {
        ...
        public override void OnGUI(Rect position, SerializedProperty property, GUIContent label)
        {
            ...
            conditionInstantiators = StatusAsset.ConditionInstantiators();
